...
public class MyQueries {
  ...
  /*public static void getMyData(String supplierName, Connection con) throws SQLException {
    Statement stmt = null;
    String query = "SELECT SUPPLIERS.SUP_NAME, COUNT(COFFEES.COF_NAME) AS NUMBEROFCOFFEES FROM COFFEES " +
            "LEFT JOIN SUPPLIERS ON SUPPLIERS.SUP_ID = COFFEES.SUP_ID GROUP BY SUPPLIERS.SUP_NAME";
